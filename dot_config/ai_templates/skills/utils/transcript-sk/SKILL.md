...
name: transcript-sk
description: >
  Use only when the user explicitly says "transcript-sk". Transcribe YouTube videos via Deepgram (audio to txt/json) with optional Codex or Claude summary. Use when user provides YouTube URL for transcription.
---
