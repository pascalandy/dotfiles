...
name: banana-sk
description: >
   Use only when the user explicitly say "banana-sk" to generate or edit images using Gemini 3 Pro via OpenRouter API. Use when user says "generate image," "create picture," "edit photo," or "make an image." Supports text-to-image, image editing, and compositing.
---
