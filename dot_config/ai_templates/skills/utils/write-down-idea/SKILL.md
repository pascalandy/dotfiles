...
description: Use when the user wants to capture a rough idea in `docs/ideas/references/`. Create a dated folder and matching idea file, keep the author's voice and language, run a `simple-editor` pass, then a `writer-sk` pass.
---

# Write Down Idea

Create an idea entry in `docs/ideas/references/`.
