...
compatibility: Requires Node 18+ and `@llamaindex/liteparse` installed globally via bun (`bun i -g @llamaindex/liteparse`)
license: MIT
metadata:
  author: LlamaIndex
  version: "0.1.0"
...
- `@llamaindex/liteparse` is installed globally (`bun i -g @llamaindex/liteparse`)
