...
**Note:** This skill is for environments without subagent support. On platforms that support subagents (e.g., Claude Code, Codex), use `superpowers:subagent-driven-development` instead — the quality of work will be significantly higher.
