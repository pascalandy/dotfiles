...
What changed:
- Kept your `Strategy` section and made it product-specific.
- Made the root decision harsher: `should this be built at all?`
- Added “kill weak branches quickly,” which matches the founder-brutal tone.
- Tightened the prompt around wedge, adoption, and scope cuts rather than generic design review.

Small wording tweak I strongly recommend: change “walk down each branch” to “walk down each materially relevant branch.” Otherwise the prompt invites useless exhaustive exploration.

If you want, I can produce a final polished version that is:
1. maximum intensity
2. brutal but elegant
3. brutal but still usable for everyday prompting
