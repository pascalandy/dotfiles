...
Use this workflow when review output already exists and the remaining work is to fix follow-ups, track them, or report workflow-level issues.
...
- Review feedback turned into concrete work or completed fixes
- A cleaner backlog with explicit ownership
- Plugin or workflow issues captured instead of silently repeated
