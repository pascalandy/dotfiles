# Technical Creativity Workflow

## Status Update

Running **TechnicalCreativity** in **BeCreative**...
...
This workflow generates creative technical solutions for engineering challenges. While the main BeCreative skill focuses on artistic creativity, creative writing, and diverse narrative ideas, this workflow specializes in algorithmic innovations, system architectures, and engineering elegance. Run it with the current assistant; if you have access to a stronger external reasoning model, that is optional, not required.

**Critical Distinction:**

| be-creative (main skill) | technical-creativity (this workflow) |
|-------------------------|----------------------------------------------|
...
| deep thinking + Verbalized Sampling | Structured technical ideation |
...
**Use technical-creativity (this workflow):**
...
## Why This Workflow Works for Technical Creativity

**Advantages for engineering problems:**

1. **Deep reasoning**: Supports multi-step technical analysis for complex challenges
2. **Pattern transfer**: Encourages cross-domain thinking and non-obvious mappings
3. **Trade-off awareness**: Forces explicit comparison of performance, complexity, cost, and maintainability
4. **Constraint clarity**: Grounds creativity in real limits instead of hand-wavy novelty
5. **Portable execution**: Works with the current assistant and optionally with any stronger external reasoning model
...
Use the current assistant directly. If an external reasoning model or CLI wrapper is available, that is optional. Use a prompt like:

```markdown
Generate 5-10 diverse creative technical solutions for this problem:
...
```markdown
Generate 5 diverse creative caching strategies for this problem:
...
```markdown
Generate 5-10 creative sorting/selection algorithms for this streaming top-K problem:
...
```markdown
Generate 5 creative database architectures for this IoT time-series problem:
...
```markdown
Generate 5-10 creative rate limiting algorithms beyond traditional token bucket:
...
```markdown
For technical creativity challenges, use the technical-creativity workflow:

1. Load workflow: `read workflows/TechnicalCreativity.md`
2. Follow the workflow structure (Problem → Constraints → Generation → Evaluation)
3. Use the current assistant directly, or optionally route the prompt through any available external reasoning model
...
- **technical-creativity** handles algorithmic solutions, architecture, implementation
...
Step 2 (technical-creativity): Design technical implementation
...
```markdown
Stage 1 prompt:
Generate 5 high-level architectural approaches for [problem].

Stage 2 prompt:
For this architecture: [selected approach]
Generate 5 creative implementations for the [specific component].

Stage 3 prompt:
For this component: [selected component]
...
```markdown
Generate solutions for [technical problem] by applying patterns from:
...
```markdown
Generate solutions for [problem] under different constraint scenarios:
...
```markdown
Generate 5-10 diverse creative technical solutions for:
