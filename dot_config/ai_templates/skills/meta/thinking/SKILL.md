...
3. **BeCreative** -- Divergent idea generation with six workflows ranging from standard creativity to maximum creativity to tree-of-thoughts exploration. Includes domain-specific creativity, technical creativity, and research-backed creative principles.
...
The collection `SKILL.md` loads `references/ROUTER.md`, which routes requests to the right thinking mode based on keyword matching. Each mode has its own `SKILL.md`, workflows, and supporting documents.

---

## Installation

This pack is designed for AI-assisted use. Give this directory to your AI and ask it to start from `SKILL.md`, then follow the routing structure into the appropriate sub-skill.
...
|--------------|----------|---------|
| Skill preferences | Host-assistant specific | Optional per-user overrides if the current assistant supports them |
...
|--------------|----------|--------|
| Council member definitions | `references/Council/references/CouncilMembers.md` | Change expertise and perspectives of debate participants |
| Council round structure | `references/Council/references/RoundStructure.md` | Modify how many rounds and what structure debates follow |
| Creative principles | `references/BeCreative/references/Principles.md` | Adjust creativity guidelines and constraints |
| Creative templates | `references/BeCreative/references/Templates.md` | Modify idea generation output formats |
| Red team philosophy | `references/RedTeam/references/Philosophy.md` | Adjust adversarial validation approach |
| Science methodology | `references/Science/references/METHODOLOGY.md` | Modify scientific method stages |
| World model template | `references/WorldThreatModelHarness/references/ModelTemplate.md` | Change world model structure |
| Iterative depth lenses | `references/IterativeDepth/references/TheLenses.md` | Add or modify analysis lenses |
