...
**Portable Evaluation Runner Reference:**
```markdown
Run the comparison with any repeatable evaluation setup that can:
- compare baseline vs. variants
- randomize or swap presentation order
- record enough samples for statistical confidence
- report accuracy and format-compliance metrics
```
