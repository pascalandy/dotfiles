---
name: single-skill-creator
description: Create new agent skills following the Agent Skills specification. Use when the user says "single-skill-creator", "create a skill", "write a skill", or wants to scaffold a new SKILL.md with proper frontmatter, structure, and progressive disclosure.
metadata:
