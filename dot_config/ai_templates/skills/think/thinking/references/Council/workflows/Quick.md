...
### Step 2: Perspective Gathering

If multi-agent execution is available, gather all council perspectives in parallel. Otherwise, collect them sequentially while preserving each role's distinct voice.
