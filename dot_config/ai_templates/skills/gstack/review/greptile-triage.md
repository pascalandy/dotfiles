...
```bash
REMOTE_SLUG=$(browse/bin/remote-slug 2>/dev/null || ~/.config/opencode/skill/gstack/browse/bin/remote-slug 2>/dev/null || ~/.claude/skills/gstack/browse/bin/remote-slug 2>/dev/null || basename "$(git rev-parse --show-toplevel 2>/dev/null || pwd)")
