...
**If "Share to Proof":**
Post the requirements document to the Proof collaborative editor:
...
Display the URL prominently: `View & collaborate in Proof: <PROOF_URL>`. If the request fails, skip silently. Then return to the Phase 4 options.
