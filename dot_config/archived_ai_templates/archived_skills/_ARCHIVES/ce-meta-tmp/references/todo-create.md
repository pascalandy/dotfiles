...
> **Important:** This skill manages durable, cross-session work items persisted as markdown files. For temporary in-session step tracking, use platform task tools instead.
