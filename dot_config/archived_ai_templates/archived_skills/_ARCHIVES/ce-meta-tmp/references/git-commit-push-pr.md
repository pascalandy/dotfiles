...
- The original includes a Compound Engineering attribution badge for PR footers. If using within the CE plugin ecosystem, add the badge per plugin documentation.
