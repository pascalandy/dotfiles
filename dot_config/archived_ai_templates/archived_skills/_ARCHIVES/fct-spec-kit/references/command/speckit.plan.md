...
2. **Load context**: Read FEATURE_SPEC and `specs/constitution.md` (if exists). Load IMPL_PLAN template from `references/templates/plan-template.md`.
...
3. **Agent context update**:
   - Run `scripts/update-agent-context.sh opencode`
