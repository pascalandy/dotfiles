...
5. **Note ambiguities** - Flag gaps; use `ask-questions` skill to clarify before proceeding
...
1. **Start with questions** if specs have gaps—use `ask-questions` skill. Don't assume.
