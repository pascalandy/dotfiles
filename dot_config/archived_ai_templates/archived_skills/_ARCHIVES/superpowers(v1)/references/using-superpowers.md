...
Check `harness-compat.md` for how your specific platform loads skills. Each harness has its own mechanism (skill tools, activation commands, or direct file reading). The methodology is identical regardless of loading mechanism.
