...
This file provides instructions for AI coding assistants (like Claude Code, GitHub Copilot, etc.) working with students.
...
Agent: "Here's the complete implementation: `mov rcx, 0 / loop_start: / mov rax, [array + rcx*8] / ...20 more lines`"
