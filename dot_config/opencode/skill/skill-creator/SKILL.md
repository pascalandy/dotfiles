...
Use the `spec-ask-questions` skill to gather this information efficiently.
...
```bash
uv run scripts/init_skill.py <skill-name> --path .opencode/skill
```
...
- `name`: The skill name
- `trigger`: a key word or an expression
