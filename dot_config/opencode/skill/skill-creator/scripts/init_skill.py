...
Examples:
    uv run init_skill.py my-new-skill --path .opencode/skill
    uv run init_skill.py my-api-helper --path .opencode/skill
    chmod +x init_skill.py, then: ./init_skill.py my-skill --path .opencode/skill
"""
...
def main():
    if len(sys.argv) < 4 or sys.argv[2] != "--path":
        ...
        print("\nExamples:")
        print("  uv run init_skill.py my-new-skill --path .opencode/skill")
        print("  uv run init_skill.py my-api-helper --path .opencode/skill")
        sys.exit(1)
