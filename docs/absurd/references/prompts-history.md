...
description: Prompts used across sessions to generate the absurd wiki content -- session context and generation instructions
tags:
  - area/ea
  - kind/log
  - status/stable
...
## to get: absurd_use_case_v2.md (now [[delivery-workflow-v2]])
...
### GOAL
Create a bonified version of the use case with all the details required to create the actual absurd workflow. This will act as our specs.

---

## to get: absurd_use_case-v1-high-level.md (now [[delivery-workflow-v1]])
...
So my goal here is to create a code factory engine so that every time I have a plan, I can simply trigger my absurd workflow and it will implement a solid solution out of it.

I think I have a great use case but I want you to double check and make sure that it is not overkill and that I'm not forgetting anything.
...
## init to get: absurd_how_to.md (now [[absurd-skill-draft]])
