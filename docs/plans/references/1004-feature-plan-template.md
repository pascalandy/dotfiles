---
name: Feature Plan Template (1004)
description: Feature/spec plan template with structured sections (Abstract through Solution Approach) and AI authoring rules
tags:
  - area/ea
  - kind/template
  - status/stable
